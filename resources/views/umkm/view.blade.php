...
@section('content')
    ...
    <section id="overview-mobile"
      class="bg-[var(--primary-600)] z-1 w-full py-4 px-6 md:py-[15px] lg:px-35 flex flex-col h-180 items-center justify-center">
    ...
    <section id="information"
      class="flex flex-col gap-3 w-screen px-5 md:px-35 bg-[var(--bg)] py-6">
        ...
        <div id="tentang-kami"
          class="flex flex-col w-full gap-3 py-6 px-5 shadow-md rounded-lg">

          <h2 class="font-semibold text-[var(--primary-500)]">Tentang Kami</h2>

          <p class="text-[11px] text-[var(--primary-500)]">{{ $umkm[0]->umkm->description }}</p>
