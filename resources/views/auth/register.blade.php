...
<body>
    ...
    <section id="mobile-device"
        ...
        <header class="px-[26px] pt-9 md:px-[38px]">
            ...
            <h1 class="font-bold text-white md:hidden text-[32px] pt-8">Selamat <br> Datang di<br> LokaHub!</h1>
        ...
        <div class="items-center justify-center bg-[var(--bg)] w-full px-[26px] rounded-t-2xl mt-10 pt-[33px] h-[700px] md:px-[38px]">
            ...
            <div class="mt-[40px]">
                <form action="{{ route('auth.postregis') }}" method="post"
                    ...
                    <div class="mt-[15px]">
                        <label for="email" value="{{ old('email') }}"
                            class="block font-medium text-[14px] text-[var(--secondary-text)] md:text-[20px]">
                            Email
                        </label>
            ...
            <div class="items-center justify-center bg-white w-full 2xl:px-56 xl:px-40 px-26 mb-10">
                ...
                <div class="mt-[40px]">
                    <form action="{{ route('auth.postregis') }}" method="post"
                            ...
                            @csrf
                        <div>
                            <label for="username" value="{{ old('username') }}"
