...
@section('content')
    ...
    <section id="mobile-device"
        ...
        <header class="px-[26px] pt-9 md:px-[38px]">
            <a href="{{ route('dashboard.user') }}">
                <img src="{{ asset('images/logo.svg') }}" alt="inspira-logo"
                    class="w-[100px]">
            </a>
        ...
        <div class="items-center justify-center bg-[var(--bg)] w-full px-[26px] rounded-t-2xl mt-10 pt-[33px] h-[700px] md:px-[38px]">
            ...
            <div class="mt-[40px]">
                <form action="{{ route('auth.postlogin') }}" method="post">
                    ...
                    <div>
                        <label for="username"
                            class="block font-medium text-[14px] md:text-[20px] text-[var(--secondary-text)]">
                            Username
                        </label>
                        <div class="relative">
                            <div class="absolute flex items-center inset-y-0 pl-3 w-6">
                                <img src="{{ asset('images/username.svg') }}" alt="">
                            </div>
                            <input type="text" name="username" placeholder="Masukkan username" class="border-1 w-full rounded-sm border-[var(--soft-border)] px-[35px] py-[10px] text-[13px] md:text-[18px]">
                        </div>
                    </div>
                    <div class="mt-[15px]">
                        <label for="password"
                        ...
                        <div class="relative">
                            <div class="absolute flex items-center inset-y-0 pl-3 w-6">
                                <img src="{{ asset('images/password-icon.svg') }}" alt="">
                            </div>
                            <input type="password" id="password" name="password" placeholder="********" class="border-1 w-full rounded-sm border-[var(--soft-border)] px-[35px] py-[10px] text-[13px] md:text-[18px]">
                        </div>
                    </div>
    ...
    <section class="hidden justify-between xl:flex">
                    ...
                    <form action="{{ route('auth.postlogin') }}" method="post"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute flex items-center inset-y-0 left-0 pl-5">
                        ...
                        <div class="mt-[20px]">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute flex items-center inset-y-0 left-0 pl-5">
                                    <img src="{{ asset('images/password-icon.svg') }}" alt="Username Icon">
                                </div>
                        ...
                        <p class="w-full mt-3 text-right text-[var(--primary-500)]">
                            <a href="#">Lupa Password?</a>
                        </p>
                        ...
                        <div class="mt-20">
                            ...
                            <p class="text-[15px] text-[var(--secondary-text)] justify-center mt-4 flex">Belum punya akun? <a href="{{ route('auth.register') }}" class="ml-1 underline"> Daftar Sekarang</a></p>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="pr-35 py-13 h-screen w-50% flex flex-col">
