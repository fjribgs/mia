                ...
                <form action="{{ route('auth.postlogin') }}" method="post"
                    ...
                    <div class="mt-[15px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" placeholder="********" class="border-1 w-full rounded-sm border-[var(--soft-border)] px-[35px] py-[10px] text-[13px] md:text-[18px]">
                    ...
                    <form action="{{ route('auth.postlogin') }}" method="post"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="username" placeholder="Masukkan username" class="border-[2px] w-full rounded-md border-
                                [var(--soft-bg)] px-[55px] py-[13px] text-[18px]">
